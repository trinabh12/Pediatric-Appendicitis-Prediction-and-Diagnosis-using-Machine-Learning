...
PHASE1_OUT = os.path.join(ROOT_DIR, "data", "phase1-results")
PHASE2_OUT = os.path.join(ROOT_DIR, "data", "phase2-results")
FINAL_OUT = os.path.join(ROOT_DIR, "data", "Final_Output")
